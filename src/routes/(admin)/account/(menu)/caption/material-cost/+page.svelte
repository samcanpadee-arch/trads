<!-- /account/caption/material-cost (v1.2 rich preview) -->
<script lang="ts">
    ...
    <div class="card-body">
      ...
      <div class="flex justify-between items-center pt-4">
        ...
        <div class="text-right space-y-1">
          <div>
            Total materials:
            <span class="font-semibold">{money(totalMaterial)}</span>
          </div>
          <div>
            Profit ({markupPct}%):
            <span class="font-semibold">{money(profit)}</span>
          </div>
          <div class="text-lg">
            Final total:
            <span class="font-bold">{money(finalTotal)}</span>
          </div>
        </div>
      </div>
    </div>
  ...
  <div class="card bg-base-100 border">
    <div class="card-body">
      ...
      <p class="text-sm opacity-70">
        Smart, trade-ready assistants to draft proposals, build estimates, and create client-ready docs.
      </p>
